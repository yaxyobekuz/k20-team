    ...
    <div className="container">
      ...
      <div className="max-w-3xl space-y-8">
        ...
        <p className="animate__animated animate__fadeInLeft text-lg text-gray-200">
          ...
          aperiam quidem dicta harum, necessitatibus ipsa eligendi ab voluptate
          incidunt provident ullam natus obcaecati dolorem omnis voluptatem
          maiores enim amet? Doloribus praesentium inventore aliquid cumque
          numquam id.
        </p>
